package com.pelagohealth.codingchallenge.presentation.theme
...
val PelagoLightColorScheme = lightColorScheme(
...
private val PelagoDarkColorScheme = darkColorScheme(
...
fun PelagoTheme(
	...
	val colorScheme = when {
		...
		isDarkTheme -> PelagoDarkColorScheme
		else -> PelagoLightColorScheme
	}
...
val Dimens: Dimensions
	@Composable
	get() = PelagoTheme.dimens

val Colors: ColorScheme
	@Composable
	get() = PelagoTheme.colorScheme
